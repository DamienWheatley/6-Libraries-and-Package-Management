...
const roundedCornerResizer = sharp().resize(200, 200).overlayWith(roundedCorners, {
  cutout: true
}).png(); //let inputPath = 'C:\\Scripts\\6 Libraries and Package Management\\src\\test-images\\test.jpg'
...
fs.createReadStream(inputtedImage).pipe(roundedCornerResizer).pipe(fs.WriteStream(comparePaths()));
